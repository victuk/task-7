...
const modelName = (process.env.MODEL_NAME!!.startsWith('openrouter/') ? process.env.MODEL_NAME :  "openrouter/" + process.env.MODEL_NAME!!) || "nvidia/nemotron-3-ultra-550b-a55b:free";
